<?php
namespace Lofi\Ftp;
require "lofi_funcs_general.php";
require "lofi_ftp_error.php";
use function \Lofi\Funcs\General\{extractFilepath, extractFilename, isValidDir, isStrEndsWith};
use \Lofi\Ftp\Error;
...
// todo: use set_exception_handler for error class
